...
namespace Klli.Sensact.Config
{
    public static class Sattlerstrasse16
    {
        ...
        public static Model Build()
        {
            ...
            SNSAC_L0_TECH_HS07_1.Applications.AddOneDimButton(ID.PUSHB_L0_WELL_B21, InputPin.I07, ID.PWM___L0_WELL_S1);//Für Dusche
            SNSAC_L0_TECH_HS07_1.Applications.AddOneDimButton(ID.PUSHB_L0_WELL_B22, InputPin.I08, ID.PWM___L0_WELL_S2); //Für WC
            ...
            SNSAC_L0_TECH_HS07_1.Applications.Add(new PWMApplication { ApplicationId = _(ID.PWM___L0_WELL_S1), StandbyController = _(ID.STDBY_L0_TECH_24V), OutputRessources = new List<PwmPin> { PwmPin.P05 } }); //Dusche
            SNSAC_L0_TECH_HS07_1.Applications.Add(new PWMApplication { ApplicationId = _(ID.PWM___L0_WELL_S2), StandbyController = _(ID.STDBY_L0_TECH_24V), OutputRessources = new List<PwmPin> { PwmPin.P06 } }); //WC
            ...
            SNSAC_L0_TECH_HS07_1.Applications.Add(new RgbwApplication { ApplicationId = _(ID.RGBW__L1_BATH_W1), StandbyController = _(ID.STDBY_L0_TECH_24V), LowMeansLampOn = true, OutputR = PwmPin.OP01, OutputB = PwmPin.OP02, OutputG = PwmPin.OP03, OutputW = PwmPin.NONE });


            //L1.CORR
            SNSAC_L0_TECH_HS07_1.Applications.Add(new DoorbellApplication
            {
                ApplicationId = _(ID.DEVCE_L1_CORR_Audio),
            });
            ...
            SNSAC_L0_TECH_HS07_1.Applications.AddToggleButton(ID.PUSHB_L1_CORR_B23, InputPin.I15, ID.POWIT_LX_FRON_W1);
            SNSAC_L0_TECH_HS07_1.Applications.AddToggleButton(ID.PUSHB_L1_CORR_B24, InputPin.I16, ID.POWIT_LX_LEFT_W1);
            ...
            SNSAC_L1_KTCH_UP02_1.Applications.Add(new PWMApplication { ApplicationId = _(ID.PWM___L1_KTCH_S1), StandbyController = _(ID.STDBY_L0_TECH_24V), OutputRessources = new List<PwmPin> { PwmPin.P16, PwmPin.P17, PwmPin.P18, PwmPin.P19 } });
            SNSAC_L1_KTCH_UP02_1.Applications.Add(new PWMApplication { ApplicationId = _(ID.PWM___L1_KTCH_S2), StandbyController = _(ID.STDBY_L0_TECH_24V), OutputRessources = new List<PwmPin> { PwmPin.P20 } });
            ...
            SNSAC_L1_LVNG_UP02_1.Applications.AddToggleButton(ID.PUSHB_L1_LVNG_B43, InputPin.I07, ID.POWIT_L1_LVNG_C1);
            SNSAC_L1_LVNG_UP02_1.Applications.AddToggleButton(ID.PUSHB_L1_LVNG_B44, InputPin.I08, ID.POWIT_L1_LVNG_W1);
            ...
            //L1.UTIL
            SNSAC_L0_TECH_HS07_2.Applications.AddOneDimButton(ID.PUSHB_L1_UTIL_B11, InputPin.I01, ID.PWM___L1_KTCH_S1);
            SNSAC_L0_TECH_HS07_2.Applications.AddBlindButtons(ID.PUSHB_L1_UTIL_B12, ID.PUSHB_L1_UTIL_B13, InputPin.I02, InputPin.I03, ID.BLIND_L1_UTIL_J1);
            ...
            SNSAC_L0_TECH_HS07_2.Applications.AddToggleButton(ID.PUSHB_L1_UTIL_B23, InputPin.I06, ID.POWIT_LX_LEFT_W1);
            SNSAC_L0_TECH_HS07_2.Applications.AddToggleButton(ID.PUSHB_L1_UTIL_B24, InputPin.I07, ID.POWIT_LX_LEFT_W1);
            ...
            //LX
            //////////////////////////////
            SNSAC_L0_TECH_HS07_2.Applications.AddPowIt(ID.POWIT_L1_CORR_P1, OutputPin.O01);
            SNSAC_L0_TECH_HS07_2.Applications.AddPowIt(ID.POWIT_L1_LVNG_P4, OutputPin.O02);
            SNSAC_L0_TECH_HS07_2.Applications.AddPowIt(ID.POWIT_LX_BACK_P1, OutputPin.O03);
            SNSAC_L0_TECH_HS07_2.Applications.AddPowIt(ID.POWIT_LX_BACK_W1, OutputPin.O04);
            SNSAC_L0_TECH_HS07_2.Applications.AddPowIt(ID.POWIT_LX_BACK_W2, OutputPin.O05);
            SNSAC_L0_TECH_HS07_2.Applications.AddPowIt(ID.POWIT_LX_BACK_W3, OutputPin.O06);
            SNSAC_L0_TECH_HS07_2.Applications.AddPowIt(ID.POWIT_LX_FRON_W1, OutputPin.O07);
            SNSAC_L0_TECH_HS07_2.Applications.AddPowIt(ID.POWIT_LX_LEFT_W1, OutputPin.O08);
            SNSAC_L0_TECH_HS07_2.Applications.AddPowIt(ID.POWIT_LX_RGHT_W1, OutputPin.O09);
            SNSAC_L0_TECH_HS07_2.Applications.AddPowIt(ID.POWIT_LX_GARA_C1, OutputPin.O10);
            SNSAC_L0_TECH_HS07_2.Applications.AddPowIt(ID.POWIT_LX_GARA_P1, OutputPin.O11);
            #endregion
            #region STDBY
            SNSAC_L0_TECH_HS07_2.Applications.Add(new StandbyController { ApplicationId = _(ID.STDBY_L0_TECH_24V), OutputRessource = OutputPin.O21, WaittimeInMsec = 10000 });
            SNSAC_L0_TECH_HS07_2.Applications.Add(new StandbyController { ApplicationId = _(ID.STDBY_L0_TECH_48V), OutputRessource = OutputPin.O22, WaittimeInMsec = 10000 });
            SNSAC_L0_TECH_HS07_2.Applications.Add(new StandbyController { ApplicationId = _(ID.STDBY_L2_CORR_24V), OutputRessource = OutputPin.O23, WaittimeInMsec = 10000 });
            #endregion
            #region L2
            ...
            //L2.BEDR
            SNSAC_L3_TECH_HS07_1.Applications.AddToggleButton(ID.PUSHB_L2_BEDR_B11, InputPin.I03, ID.POWIT_L2_BEDR_P3);
            ...
            SNSAC_L3_TECH_HS07_1.Applications.AddToggleButton(ID.PUSHB_L2_BEDR_B21, InputPin.I08, ID.POWIT_L2_BEDR_P3);
            SNSAC_L3_TECH_HS07_1.Applications.AddOneDimButton(ID.PUSHB_L2_BEDR_B22, InputPin.I09, ID.PWM___L2_BEDR_S);
            SNSAC_L3_TECH_HS07_1.Applications.AddToggleButton(ID.PUSHB_L2_BEDR_B23, InputPin.I10, ID.POWIT_L2_BEDR_P2);
            ...
            SNSAC_L3_TECH_HS07_1.Applications.AddBlindButtons(ID.PUSHB_L2_CORR_B42, ID.PUSHB_L2_CORR_B43, InputPin.I21, InputPin.I22, ID.BLIND_L2_BEDR_J1);
            ...
            //Spots werden über Up-Modul versorgt
            ...
            //WORK (und neues sensacHS ab hier)
            ...
            #region L3
            //BEDR
            SNSAC_L3_TECH_HS07_2.Applications.AddToggleButton(ID.PUSHB_L3_BEDR_B11, InputPin.I27, ID.POWIT_L2_KID2_C1);
            ...
            SNSAC_L3_TECH_HS07_2.Applications.AddToggleButton(ID.PUSHB_LS_STRS_B11, InputPin.II01, ID.PWM___LS_STRS_W2);
            ...
            SNSAC_L3_TECH_HS07_2.Applications.AddToggleButton(ID.PUSHB_LS_STRS_B31, InputPin.II02, ID.PWM___LS_STRS_W2);
            SNSAC_L3_TECH_HS07_2.Applications.AddToggleButton(ID.PUSHB_LS_STRS_B32, InputPin.II03, ID.PWM___LS_STRS_W4);
            ...
            SNSAC_L3_TECH_HS07_2.Applications.AddToggleButton(ID.PUSHB_LS_STRS_B51, InputPin.II04, ID.PWM___LS_STRS_W4);
            SNSAC_L3_TECH_HS07_2.Applications.AddToggleButton(ID.PUSHB_LS_STRS_B52, InputPin.II05, ID.PWM___LS_STRS_W6);
            ...
            SNSAC_L3_TECH_HS07_2.Applications.AddToggleButton(ID.PUSHB_LS_STRS_B71, InputPin.II06, ID.PWM___LS_STRS_W6);
