...
document.addEventListener("DOMContentLoaded", (e) => {
  app = new AppController("SensAct WebUI", CONST.WS_URL, null, false, `:: Node ${CFG.SENSACT_NODE_NAME} :: SensactModel ${CFG.SENSACT_MODEL_NAME} created at  ${CFG.SENSACT_MODEL_CREATION_DT_STRING} `);
