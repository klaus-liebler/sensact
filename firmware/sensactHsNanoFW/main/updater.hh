...
private:
    ...
    static esp_err_t _http_event_handler(esp_http_client_event_t *evt)
    {
        ...
        case HTTP_EVENT_ON_FINISH:
            ...
            {
                ESP_LOGI(TAG, "Response is accumulated in output_buffer %p of len %d.", output_buffer, output_len);
                ESP_LOG_BUFFER_HEX(TAG, output_buffer, output_len);
                cJSON *ota_json = cJSON_Parse(output_buffer);
    ...
    static void updaterTask(void *pvParameters)
    {
        ...
        {
            ESP_LOGI(TAG "Update Process starts due to %s", myself->manualUpdateRequested ? "manual request" : "timer");
