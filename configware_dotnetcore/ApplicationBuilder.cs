...
namespace Klli.Sensact.Config
{
    public static class AB
    {
        ...
        {
            return new RotaryEncoder2PWMApplication((ushort)appId, appId.ToString(), rotEnc, (ushort)targetAppId);
        }
        ...
        public static void AddBlindButtons(this List<SensactApplication> list, Nodes.ApplicationId appIdUp, ushort inputPinUp, ushort inputPinDown, ApplicationId targetAppId)
        {
