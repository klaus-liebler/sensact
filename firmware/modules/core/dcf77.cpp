...
void cDCF77::CallEveryMillisecond(uint32_t tick)
{
	...
	static uint8_t lastSignal = 0; // hier "Ruhesignal"-Level eintragen
	//Signal ist 100ms oder 200ms high
	//Beim Sekundenwechsel ist das Signal mehr als 1000ms low
	uint8_t signal =  BSP::SampleDCF77Pin();//SignalConditioning();//
...
bool cDCF77::SetBit(uint8_t second, uint8_t bitValue)
{
	...
	switch (second) {
		...
		case 20:
			...
			break;
		case 21:minScratch+=1*bitValue; parityScratch+=bitValue;break;
		case 22:minScratch+=2*bitValue;	parityScratch+=bitValue;break;
		case 23:minScratch+=4*bitValue;	parityScratch+=bitValue;break;
		case 24:minScratch+=8*bitValue;	parityScratch+=bitValue;break;
		case 25:minScratch+=10*bitValue;parityScratch+=bitValue;break;
		case 26:minScratch+=20*bitValue;parityScratch+=bitValue;break;
		case 27:minScratch+=40*bitValue;parityScratch+=bitValue;break;
		case 28:
			...
			parityScratch=0;
			break;
		case 29:hourScratch+=1*bitValue;parityScratch+=bitValue;break;
		case 30:hourScratch+=2*bitValue;parityScratch+=bitValue;break;
		case 31:hourScratch+=4*bitValue;parityScratch+=bitValue;break;
		case 32:hourScratch+=8*bitValue;parityScratch+=bitValue;break;
		case 33:hourScratch+=10*bitValue;parityScratch+=bitValue;break;
		case 34:hourScratch+=20*bitValue;parityScratch+=bitValue;break;
		case 35:
			parityScratch+=bitValue;
			if(parityScratch%2!=0)
			{
			...
			parityScratch=0;
			break;
		case 36:calenderDayScratch+=1*bitValue;parityScratch+=bitValue;break;
		case 37:calenderDayScratch+=2*bitValue;parityScratch+=bitValue;break;
		case 38:calenderDayScratch+=4*bitValue;parityScratch+=bitValue;break;
		case 39:calenderDayScratch+=8*bitValue;parityScratch+=bitValue;break;
		case 40:calenderDayScratch+=10*bitValue;parityScratch+=bitValue;break;
		case 41:calenderDayScratch+=20*bitValue;parityScratch+=bitValue;break;
		case 42:weekDayScratch+=1*bitValue;parityScratch+=bitValue;break;
		case 43:weekDayScratch+=2*bitValue;parityScratch+=bitValue;break;
		case 44:weekDayScratch+=4*bitValue;parityScratch+=bitValue;break;
		case 45:monthScratch+=1*bitValue;parityScratch+=bitValue;break;
		case 46:monthScratch+=2*bitValue;parityScratch+=bitValue;break;
		case 47:monthScratch+=4*bitValue;parityScratch+=bitValue;break;
		case 48:monthScratch+=8*bitValue;parityScratch+=bitValue;break;
		case 49:monthScratch+=10*bitValue;parityScratch+=bitValue;break;
		case 50:yearScratch+=1*bitValue;parityScratch+=bitValue;break;
		case 51:yearScratch+=2*bitValue;parityScratch+=bitValue;break;
		case 52:yearScratch+=4*bitValue;parityScratch+=bitValue;break;
		case 53:yearScratch+=8*bitValue;parityScratch+=bitValue;break;
		case 54:yearScratch+=10*bitValue;parityScratch+=bitValue;break;
		case 55:yearScratch+=20*bitValue;parityScratch+=bitValue;break;
		case 56:yearScratch+=40*bitValue;parityScratch+=bitValue;break;
		case 57:yearScratch+=80*bitValue;parityScratch+=bitValue;break;
		case 58:
			parityScratch+=bitValue;
			if(parityScratch%2!=0)
			{
