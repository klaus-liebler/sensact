...
namespace Klli.Sensact.Config.Applications
{
    public class StandbyControllerApplication : ActorApplication
    {
        ...
        public override string GenerateInitializer(ModelContainer m)
        {
            ...
            sb.AppendFormat("sensactapps::cStandbyController {0}(eApplicationID::{0}, {1}, {2});" + Environment.NewLine + Environment.NewLine, ApplicationId, OutputRessource, WaittimeInMsec);
            return sb.ToString();
        }
