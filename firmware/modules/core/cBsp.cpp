...
#ifdef SENSACTUP01
const char BSP::SystemString[] = "sensactup 0.1, (c) Klaus M. Liebler, compiled " __DATE__ " " __TIME__"\r\n";
...
#ifdef SENSACTUP02
const char BSP::SystemString[] = "sensactup 0.2, (c) Klaus M. Liebler, compiled " __DATE__ " " __TIME__"\r\n";
...
#ifdef SENSACTUP03
const char BSP::SystemString[] = "sensactup 0.3, (c) Klaus M. Liebler, compiled " __DATE__ " " __TIME__"\r\n";
const char BSP::gimmick[] ="  ____                            _   _   _          ___   ____  \r\n / ___|  ___ _ __  ___  __ _  ___| |_| | | |_ __    / _ \\ |___ \\ \r\n \\___ \\ / _ \\ '_ \\/ __|/ _` |/ __| __| | | | '_ \\  | | | |  __) |\r\n  ___) |  __/ | | \\__ \\ (_| | (__| |_| |_| | |_) | | |_| | / __/ \r\n |____/ \\___|_| |_|___/\\__,_|\\___|\\__|\\___/| .__/   \\___(_)_____|\r\n                                           |_|                   ";
DMA_HandleTypeDef hdma_tim1_ch1;
...
#ifdef SENSACTUP04
const char BSP::SystemString[] = "sensactup 0.4, (c) Klaus M. Liebler, compiled " __DATE__ " " __TIME__"\r\n";
const char BSP::gimmick[] ="  ____                            _   _   _          ___   ____  \r\n / ___|  ___ _ __  ___  __ _  ___| |_| | | |_ __    / _ \\ |___ \\ \r\n \\___ \\ / _ \\ '_ \\/ __|/ _` |/ __| __| | | | '_ \\  | | | |  __) |\r\n  ___) |  __/ | | \\__ \\ (_| | (__| |_| |_| | |_) | | |_| | / __/ \r\n |____/ \\___|_| |_|___/\\__,_|\\___|\\__|\\___/| .__/   \\___(_)_____|\r\n                                           |_|                   ";
DMA_HandleTypeDef hdma_tim1_ch1;
I2C_HandleTypeDef BSP::i2c1;
I2C_HandleTypeDef BSP::i2c2;
...
#ifdef SENSACTHS04
const char BSP::SystemString[] = "sensactHS04 2015-07-27, (c) Klaus M. Liebler, compiled " __DATE__ " " __TIME__"\r\n";
...
#ifdef SENSACTHS07
const char BSP::SystemString[] = "sensactHS07 2015-11-16, (c) Klaus M. Liebler, compiled " __DATE__ " " __TIME__"\r\n";
...
#ifdef SENSACTHS08
const char BSP::SystemString[] = "sensactHS08 (Lochblech) 2017-05-11, (c) Klaus M. Liebler, compiled " __DATE__ " " __TIME__"\r\n";
...
const char BSP::LicenseString[] = "sensact (c)  Klaus M. Liebler - Apache License 2.0\r\n";
...
#elif defined(SENSACTHS04) or defined(SENSACTHS07) or defined(SENSACTHS08)
	UU(re);
	return 0;
#elif
