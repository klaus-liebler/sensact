...
public:
	 ...
	 */
	static eShellError processCmds(uint8_t * cmd_line, uint8_t size);
	static eShellError processBinaryCmd(uint8_t * cmdBuffer, uint8_t size);
	static eShellError processTextCmd(const char * cmd_line, uint8_t size);
};
}
