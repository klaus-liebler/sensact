...
namespace Klli.Sensact.Config.Applications
{
    public class PushButtonXApplication : SensorApplication
    {
        ...
        public override string GenerateInitializer(ModelContainer m)
        {
            ...
            sb.AppendFormat("sensactapps::cPushbuttonX {0}(eApplicationID::{0}, {1}, {0}_LocalEvents, {2}, {0}_BusEvents, {3}, {0}_OnPressed, {4}, {0}_OnReleased, {5}, {0}_OnReleasedShort, {6}, {0}_OnPressedShortAndHold, {7}, {0}_OnReleasedLong, {8}, {0}_OnDoubleclick, {9});" + Environment.NewLine + Environment.NewLine, 
