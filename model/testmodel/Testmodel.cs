...
namespace Klli.Sensact.Config
{
    ...
    public static class TestModelBuilder
    {
        ...
        public static Klli.Sensact.Model.Common.Model TwoNodesDemo()
        {
            ...
            NODE_HS.Applications.AddPowIt(Model.ApplicationId.POWIT_9, BUS0+I2C+0, 5000);//erstes Licht
            NODE_HS.Applications.AddPowIt(Model.ApplicationId.POWIT_10, BUS0+I2C+1, 5000);//zweites Licht
            NODE_HS.Applications.AddPowIt(Model.ApplicationId.POWIT_11, BUS0+I2C+2, 5000);//drittes Licht
            NODE_HS.Applications.AddPowIt(Model.ApplicationId.POWIT_12, BUS0+I2C+3, 5000);//viertes Licht
            NODE_HS.Applications.AddBlindApplication(Model.ApplicationId.BLIND_XX_XXX_13, BUS0+I2C+4, BUS0+I2C+5, RelayInterlockMode.R1_DOWN__R2_POWER, 8, 5);
            NODE_HS.Applications.AddPWMApplication(Model.ApplicationId.PWM___XX_XXX_14, Model.ApplicationId.STDBY_XX_XXX_15, new HashSet<ushort>{BUS0+I2C+6}, 5000, 20, 255);
            NODE_HS.Applications.AddPowIt(Model.ApplicationId.STDBY_XX_XXX_15, BUS0+I2C+7, 10000);//ist der Standny für die PWMApplication
            NODE_HS.Applications.Add(new SoundApplication((ushort)Model.ApplicationId.SOUND_XX_XXX_0, Model.ApplicationId.SOUND_XX_XXX_0.ToString(), 20, 1));
