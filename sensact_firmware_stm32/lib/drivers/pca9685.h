...
class cPCA9685:public Output_16_UINT16_Provider{
private:
...
public:
	...
	cPCA9685(ePCA9685Device device, ePCA9685_InvOutputs inv, ePCA9685_OutputDriver outdrv, ePCA9685_OutputNotEn outne, ePCA9685_Frequency freq);
	sensactcore::Error Init(sensacthal::SensactHAL *hal, sensacthal::SensactBus bus);
	ePCA9685Device GetDevice();
	static sensactcore::Error SoftwareReset(sensacthal::SensactHAL *hal, sensacthal::SensactBus bus);
	//static sensactcore::Error SetOutputs(sensacthal::SensactHAL *hal, sensacthal::SensactBus bus, uint8_t deviceOffset, uint16_t mask, uint16_t val);
	Error SetOutput(uint8_t outputOnly4LowerBitsConsidered, uint16_t value);
