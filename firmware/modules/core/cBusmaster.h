...
public:
	...
	//ein byte Inputs, ein byte Luftqualit�t (0 ist schlecht, 255 is super, 256 ist nicht definiert), ein Byte Luftfeuchte (0...100%, 256 ist nicht definert), zwei Byte Temperatur, ein byte Payload-Spezifikation,  zwei Byte Payload
