...
/* Basic operations */
#define ST7789_RST_Clr() Gpio::Set(ST7789_RST_Pin, false)
#define ST7789_RST_Set() Gpio::Set(ST7789_RST_Pin, true)

#define ST7789_DC_Clr() Gpio::Set(ST7789_DC_Pin, false)
#define ST7789_DC_Set() Gpio::Set(ST7789_DC_Pin, true)

#define ST7789_Select() Gpio::Set(ST7789_CS_Pin, false)
#define ST7789_UnSelect() Gpio::Set(ST7789_CS_Pin, true)
